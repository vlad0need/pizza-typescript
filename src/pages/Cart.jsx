...
function Cart() {
  ...
  const pizzaz = useSelector((state) => state.cart.items )
  const sumPizzaz = useSelector((state) => state.cart.sum )
  const totalCountPizazz = pizzaz.reduce((sum, item) => sum + item.count, 0 ) 
...
<path d="M11.6666 9.16667V14.1667" stroke="#B6B6B6" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div class="cart__bottom">
              <div class="cart__bottom-details">
                <span> Всього піц <b>{totalCountPizazz} шт.</b> </span>
                <span> Сумма заказа: <b>{sumPizzaz} ₴</b> </span>
              </div>
